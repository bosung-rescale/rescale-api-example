...
if __name__ == '__main__':
    ...
    if (api_key == None) or (rescale_platform == None) :
        print("usage: monitoring_job.py [-h] --id ID [--key KEY] [--platform PLATFORM]")
        exit(1)
...
# Job Info 
    job_info_url = rescale_platform + '/api/v2/jobs/'+job_id
    ...
    print(json.dumps(job_info_dict, indent=2, separators=(',',': ')))
    print()
